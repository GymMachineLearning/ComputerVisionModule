...
def get_pose2D(video_path, output_dir):
    ...
    print("keypoints coco format: ", keypoints)
    print("keypoints coco format shape: ", keypoints.shape)

    print("scores coco format shape: ", scores)
    print("scores coco format shape: ", scores.shape)
